(() => {
    ...
    accordeonTitles.forEach.call(accordeonTitles, (function(accordeonTitle) {
        accordeonTitle.addEventListener("click", (function() {
            ...
            if (currentText.classList.contains("accordeon__text--visible")) currentText.style.maxHeight = currentText.scrollHeight + "px"; else currentText.style.maxHeight = null;
        }));
    }));
    ...
    let tab = function() {
        let tabName, tabNav = document.querySelectorAll(".product__volume-link"), tabContent = document.querySelectorAll(".product__img-item"), tabBuy = document.querySelectorAll(".product__buy");
        tabNav.forEach((item => {
        ...
        function selectTabNav() {
            ...
            tabName = this.getAttribute("data-btn");
    ...
    window.addEventListener("scroll", activeTopBtn);
    (new WOW).init();
    window["FLS"] = true;
    isWebp();
})();